"""
Basic Linear Workflow for AI Content Agency
Connects all four agents in a simple sequential flow:
Manager -> Research -> Writer -> Review -> End
"""
...
def create_basic_workflow():
    ...
    Flow: Manager -> Research -> Writer -> Review -> End
