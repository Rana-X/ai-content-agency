"""
Basic Linear Workflow with Research Subgraph Integration
Connects all four agents with research as a subgraph:
Manager -> Research (Subgraph) -> Writer -> Review -> End
"""
...
def create_basic_workflow():
    ...
    Flow: Manager -> Research (Subgraph) -> Writer -> Review -> End
    ...
    # Replace ResearchAgent with subgraph
...
if __name__ == "__main__":
    """Test the basic workflow with a sample topic"""
    
    print("Starting workflow test with SUBGRAPH...")
    print("-" * 50)
